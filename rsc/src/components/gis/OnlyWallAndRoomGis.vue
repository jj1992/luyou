  ...
  <div class="map">
      <vflex style="height:100vh" :middleStyle="{}">
          ...
          <div slot="middle">
                    ...
                    <!-- 选取坐标弹出框 -->
                    <mu-dialog :open.sync="openDialog" max-width="100%" width="96%" scrollable padding-bottom='0'>
...
//   created() {
//     console.log(this.id,this.type,this.deviceClass)
//   },
  methods: {
    navigate_back(){
        this.$router.back(-1);
