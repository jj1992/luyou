            ...
            <mu-list-item  nested :open="open === 0">
                <mu-list-item-content @click="toggleShow(0)">
                    ...
                    <mu-list-item-sub-title >
                        <span class="item">
                        {{data.office}}|{{data.state}}|{{data.opticalCablePurpose}}
                        </span>
                    </mu-list-item-sub-title>
                ...
                <mu-list-item-action>
                    ...
                    <router-link :to="{path:'/opticalCableDetail',query:{id:data.id}}">详情</router-link>
...
export default {
    ...
    methods:{
        ...
        loadData(){
            ...
            this.$axios.post("/guanglan/details",params).then((res)=>{
                this.loadingData = 0;
