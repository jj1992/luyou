            ...
            <mu-list-item  nested :open="open === 0">
                ...
                <mu-list-item-content @click="toggleShow(0)">
                    <mu-list-item-title class="wall_title">
                        ...
                        {{data.name}}|{{data.code}}|{{data.shortName}}
                    </mu-list-item-title>

                    <mu-list-item-sub-title >
                        <span class="item">
                        {{data.reseau}}|{{data.bureau}}
                        </span>
                    </mu-list-item-sub-title>
                ...
                <mu-list-item-action>
                    ...
                    <router-link :to="{path:'/outDoorDetail',query:{id:data.id}}">详情</router-link>
...
export default {
    ...
    methods:{
        ...
        loadData(){
            ...
            this.$axios.post("/outdoorpoint/details",params).then(function(response){
                that.loadingData = 0;
