            ...
            <mu-list-item  nested :open="open === 0">
                <mu-list-item-content @click="toggleShow(0)">
                    <mu-list-item-title class="wall_title">
                        ...
                        {{data.ganluduanbianhao}}
                    </mu-list-item-title>

                    <mu-list-item-sub-title >
                        <span class="item">
                        {{data.aqujumingcheng}}|{{data.ajusuomingcheng}}
                        </span>
                    </mu-list-item-sub-title>
                ...
                <mu-list-item-action>
                    ...
                    <router-link :to="{path:'/barsectionDetail',query:{id:data.id}}">详情</router-link>
...
export default {
    ...
    methods:{
        ...
        loadData(){
            ...
            this.$axios.post("/ganluduan/ganLuDuanDetails",params).then((res)=>{
                this.loadingData = 0;
